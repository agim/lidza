---
name: extend-admin-pages
description: "Give the app's own operations a page in the admin pages (orders to refund, a moderation queue, a report), or its own keys a settings form, instead of a separate admin screen."
---
