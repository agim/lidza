---
name: add-llm-feature
description: "Put a language model behind an API route: a chat reply, a summary, a structured extraction into a schema type, or a model that uses the app's tools. The llm pack speaks the providers; the app never does."
---
