...
description: "Make a resource answer only with the rows its user may see: the generated handlers are unscoped, and a row another user may not read is a 404, never a 403 (the reply must not confirm it exists)."
---
