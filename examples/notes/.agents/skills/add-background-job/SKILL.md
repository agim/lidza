...
description: "Do work outside the request (send a notification, resize an upload, call a slow API) through the jobs pack: the request enqueues, a worker runs the handler later with retries, on this node or another."
---
