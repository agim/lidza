...
func TestNewReact(t *testing.T) {
	...
	for _, f := range []string{
		...
		"CLAUDE.md", "AGENTS.md", "GEMINI.md", "docs/lidza-guide.md", "docs/decisions.md", "README.md", ".github/workflows/ci.yml",
	...
	if !strings.Contains(read("CLAUDE.md"), "<!-- lidza:recipes -->`add-api-route`, `add-resource`, `add-sign-in`, `scope-query-to-signed-in-user`, `add-page`, `add-pack-capability`, `add-mcp-tool`, `send-email`, `add-background-job`, `publish-live-updates`, `add-llm-feature`, `store-file`, `add-admin-pages`, `add-recipe`, `write-test`<!-- /lidza:recipes -->") {
