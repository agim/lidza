---
name: publish-live-updates
description: "Let every open page of a resource see a change without reloading, through the realtime pack: handlers publish on a topic after a write, the page subscribes and refetches."
---
